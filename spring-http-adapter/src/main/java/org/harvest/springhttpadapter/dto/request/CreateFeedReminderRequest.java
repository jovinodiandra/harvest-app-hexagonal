...
@Schema(description = "Request body untuk menambah pengingat pakan")
public record CreateFeedReminderRequest(
        ...
        @Schema(description = "Jenis pakan", example = "Pellet Hi-Pro", required = true)
        String feedType,
        
        @Schema(description = "Catatan tambahan", example = "Pakan pagi, jumlah 2kg")
        String notes
) {
}
